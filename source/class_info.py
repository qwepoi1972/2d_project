...
class Player(pygame.sprite.Sprite):
    def __init__(self, screen, start_x, start_y):
        ...
        super().__init__()
        self.screen = screen
        self.image_stand = pygame.image.load("sprites/mario_stand_right.png")
        self.image_jump = pygame.image.load("sprites/mario_jump_right.png")
...
class Platform(pygame.sprite.Sprite):
    def __init__(self, screen, pos_y, width, height):
        ...
        self.image = pygame.image.load("sprites/platform.jpg")
